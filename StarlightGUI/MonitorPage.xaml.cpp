...
namespace winrt::StarlightGUI::implementation
{
	...
	MonitorPage::MonitorPage() {
		...
		MonitorSegSSDTUid().Text(GetLocalizedString(L"Monitor_Seg_SSDT.Text"));
		MonitorSegSSSDTUid().Text(GetLocalizedString(L"Monitor_Seg_SSSDT.Text"));
		MonitorSegIOTimerUid().Text(GetLocalizedString(L"Monitor_Seg_IOTimer.Text"));
		MonitorSegExCallbackUid().Text(GetLocalizedString(L"Monitor_Seg_ExCallback.Text"));
		...
		RefreshButton().Label(GetLocalizedString(L"Monitor_Refresh.Label"));
	...
	void MonitorPage::ObjectListView_RightTapped(IInspectable const& sender, winrt::Microsoft::UI::Xaml::Input::RightTappedRoutedEventArgs const& e)
	{
		...
		if (item.Type() == L"SymbolicLink") {
			...
			hstring state = item.EventSignaled() ? GetLocalizedString(L"Monitor_BoolTrue") : GetLocalizedString(L"Monitor_BoolFalse");
			...
			hstring state = item.MutantAbandoned() ? GetLocalizedString(L"Monitor_BoolTrue") : GetLocalizedString(L"Monitor_BoolFalse");
			...
			hstring state = item.TimerState() ? GetLocalizedString(L"Monitor_BoolTrue") : GetLocalizedString(L"Monitor_BoolFalse");
